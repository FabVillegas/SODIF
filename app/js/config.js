angular.module('sodif', ['ui.router', 'ngGrid', 'angularCharts', 'ui.bootstrap', 'datePicker', 'angular-datepicker']).config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
